System.register("chunks:///_virtual/back-to-asset-loading.ts", ['./_rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      let BackToAssetLoading = exports('BackToAssetLoading', (_dec = ccclass('BackToAssetLoading'), _dec(_class = (_class2 = (_temp = class BackToAssetLoading extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, _temp), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "sceneToBack", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
